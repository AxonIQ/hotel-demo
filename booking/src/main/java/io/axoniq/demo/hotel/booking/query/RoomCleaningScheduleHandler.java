...
class RoomCleaningScheduleHandler {
    ...
    @ResetHandler
    public void onReset(){
        logger.info("Resetting room cleaning repository");
        logger.info("Removing {} records", this.roomCleaningScheduleRepository.count());
        roomCleaningScheduleRepository.deleteAllInBatch();
    }
}
